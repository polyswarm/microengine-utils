...
def configure_metrics(datadog_api_key, datadog_app_key, engine_name, os_type, poly_work, source):
    """
    ...
    if datadog_api_key is not None or datadog_app_key is not None:
        ...
        metrics_collector = ThreadStats(namespace='polyswarm', constant_tags=[
